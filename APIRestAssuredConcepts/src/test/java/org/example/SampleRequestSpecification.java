...
public class SampleRequestSpecification {
    ...
    public void verifyBody(){
        ...
        given().spec(requestSpecification)
                .when().get("/us/90210")
                .then()
                .spec(responseSpecification).body("country",equalTo("United States"));
    }
    @Test
    ...
    public void verifyContentType(){
        //https://www.zippopotam.us/us/90210
        given().spec(requestSpecification)
                .when().get("/us/90210").then().spec(responseSpecification).contentType("application/json");
    }
}
